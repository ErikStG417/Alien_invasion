...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.game_active:
            ...
            #Get ride of remaining bullets and aliens.
            self.bullets.empty()
            self.aliens.empty()

            # Crate a new fleet amd center the ship.
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        # Spacing betwwen aliens is on alien width and one alien height.
    ...
    def _ship_hit(self):
        """Respond to the shop being hit by an alien."""
        #Decrement ships_left
        if self.stats.ships_left > 0:
            # Drecrement ship_left, and update scoreboard
